...
assert_contains "dashboard section" "<section id=\"dashboard\"" "$out"
assert_contains "dashboard title" "Final Output: AI Due Diligence Report" "$out"
...
assert_not_contains "no recommendation ribbon" "recommendation-ribbon" "$out"
assert_not_contains "no recommendation section" "Recommendation" "$out"
